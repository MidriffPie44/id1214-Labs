...
def create_training_data(amount, min_medal=0, max_medal=1000):
...
if __name__ == '__main__':
    ...
    data_samples, data_labels, _ = create_training_data(100000, min_medal=0, max_medal=100)
    eval_samples, eval_labels, match_ids = create_training_data(100, min_medal=0, max_medal=100)
